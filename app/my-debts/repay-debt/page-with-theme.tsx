...
// Mock data for debts (与原页面相同)
// ... 在这里保留原来的 mock data 和接口定义 ...
...
export default function RepayDebtPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <Title
        level={2}
        style={{ color: componentStyles.text.title.color, marginBottom: 24 }}
      >
        Debt Repayment
      </Title>
      ...
      >
        {selectedDebt && (
          <div className={componentStyles.text.primary}>
            <p>
              <strong className={componentStyles.text.primary}>
                Token Batch:
              </strong>{" "}
            ...
            <div className="mt-4">
              <Text strong className={componentStyles.text.primary}>
                Repayment Amount
              </Text>
              <InputNumber
              ...
              <div className="flex justify-between mt-4">
                <Button
                  ...
                  className={componentStyles.button.default}
                >
                  25%
                </Button>
                <Button
